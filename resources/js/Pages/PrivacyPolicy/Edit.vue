<template>
  <Head title="Edit Privacy Policy Page"/>
...
const resetEditForm = () => {
  form.content_en = props.policy.content_en ?? ''
  form.content_km = props.policy.content_km ?? ''
}
...
const submit = () => {
  form.transform(data => ({
    ...data,
    _method: 'PUT'
  })).post(route('page.update', {page_key: 'policy'}), {
