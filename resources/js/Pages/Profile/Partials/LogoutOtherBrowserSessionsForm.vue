...
<template>
  <CardBox title="Browser Sessions">
    ...
    <div class="flex items-center mt-5">
      <BaseButton label="Log Out Other Browser Sessions" color="contrast" @click="confirmLogout"/>
    ...
    <JetDialogModal :show="confirmingLogout" @close="closeModal">
      ...
      <template #content>
        ...
        <form>
          <input type="text" v-show="false" autocomplete="username">
          <div class="mt-4">
            <JetInput
              ref="passwordInput"
