<template>
  <Head title="Edit Terms of Service Page"/>
  ...
  <LayoutAuthenticated>
    <SectionMain>
      <SectionTitleBarSub
        ...
        main
        title="Edit Terms of Service Page"
      />
...
const resetEditForm = () => {
  form.content_en = props.terms.content_en ?? ''
  form.content_km = props.terms.content_km ?? ''
}
...
const submit = () => {
  form.transform(data => ({
    ...data,
    _method: 'PUT'
  })).post(route('page.update', {page_key: 'terms'}), {
